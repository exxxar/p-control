...
public class ContractorForm {
  ...
  private List<ContractorSchedule> schedule = new ArrayList<ContractorSchedule>();
  ...
  private List<Integer> problemCategories = new ArrayList<Integer>();
  ...
  public ContractorForm mnemonicName(String mnemonicName) {
   ...
   * @return mnemonicName
  **/
  @ApiModelProperty(example = "mvd", required = true, value = "Мнемоническое имя")
  ...
  public ContractorForm title(String title) {
   ...
   * @return title
  **/
  @ApiModelProperty(example = "Министерство внутренних дел", required = true, value = "Название исполнительного органа")
  ...
  public ContractorForm description(String description) {
   ...
   * @return description
  **/
  @ApiModelProperty(example = "Министерство внутренних дел - контролирующий орган", required = true, value = "Описание исполнительного органа")
  ...
  public ContractorForm responsiblePerson(String responsiblePerson) {
  ...
  **/
  @ApiModelProperty(example = "Петров В.В., старший лейтинант", required = true, value = "Ответственное лицо от органа исполнения  проверки")
  ...
  public ContractorForm image(String image) {
  ...
  **/
  ...
  public ContractorForm hashTag(String hashTag) {
   ...
   * @return hashTag
  **/
  @ApiModelProperty(example = "#мвд", required = true, value = "")
  ...
  public ContractorForm contactPhone(String contactPhone) {
   ...
   * @return contactPhone
  **/
  @ApiModelProperty(example = "0713333333", required = true, value = "")
  ...
  public ContractorForm contactEmail(String contactEmail) {
   ...
   * @return contactEmail
  **/
  @ApiModelProperty(example = "mvd@mvd.com", required = true, value = "")
  ...
  public ContractorForm preControllerEmail(String preControllerEmail) {
  ...
  **/
  ...
  public ContractorForm telegramChatId(String telegramChatId) {
  ...
  **/
  @ApiModelProperty(example = "-10000000001", required = true, value = "идентификатор телеграм канала исполнительного органа")
  ...
  public ContractorForm publicWebsite(String publicWebsite) {
  ...
  **/
  ...
  public ContractorForm moreInfo(String moreInfo) {
  ...
  **/
  ...
  public ContractorForm type(TypeEnum type) {
  ...
  **/
  ...
  public ContractorForm schedule(List<ContractorSchedule> schedule) {
    
    this.schedule = schedule;
    return this;
  }

  public ContractorForm addScheduleItem(ContractorSchedule scheduleItem) {
  ...
  **/
  ...
  public ContractorForm problemCategories(List<Integer> problemCategories) {
    
    this.problemCategories = problemCategories;
    return this;
  }

  public ContractorForm addProblemCategoriesItem(Integer problemCategoriesItem) {
  ...
  **/
  ...
  public List<Integer> getProblemCategories() {
    return problemCategories;
  }


  public void setProblemCategories(List<Integer> problemCategories) {
    this.problemCategories = problemCategories;
  }


  public ContractorForm isActive(Boolean isActive) {
  ...
  **/
  ...
  public ContractorForm generateDailyReport(Boolean generateDailyReport) {
  ...
  **/
  ...
  public ContractorForm needInformByEmail(Boolean needInformByEmail) {
  ...
  **/
  ...
  public ContractorForm needInformBySms(Boolean needInformBySms) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ContractorForm contractorForm = (ContractorForm) o;
    return Objects.equals(this.mnemonicName, contractorForm.mnemonicName) &&
        Objects.equals(this.title, contractorForm.title) &&
        Objects.equals(this.description, contractorForm.description) &&
        Objects.equals(this.responsiblePerson, contractorForm.responsiblePerson) &&
        Objects.equals(this.image, contractorForm.image) &&
        Objects.equals(this.hashTag, contractorForm.hashTag) &&
        Objects.equals(this.contactPhone, contractorForm.contactPhone) &&
        Objects.equals(this.contactEmail, contractorForm.contactEmail) &&
        Objects.equals(this.preControllerEmail, contractorForm.preControllerEmail) &&
        Objects.equals(this.telegramChatId, contractorForm.telegramChatId) &&
        Objects.equals(this.publicWebsite, contractorForm.publicWebsite) &&
        Objects.equals(this.moreInfo, contractorForm.moreInfo) &&
        Objects.equals(this.type, contractorForm.type) &&
        Objects.equals(this.schedule, contractorForm.schedule) &&
        Objects.equals(this.problemCategories, contractorForm.problemCategories) &&
        Objects.equals(this.isActive, contractorForm.isActive) &&
        Objects.equals(this.generateDailyReport, contractorForm.generateDailyReport) &&
        Objects.equals(this.needInformByEmail, contractorForm.needInformByEmail) &&
        Objects.equals(this.needInformBySms, contractorForm.needInformBySms);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mnemonicName, title, description, responsiblePerson, image, hashTag, contactPhone, contactEmail, preControllerEmail, telegramChatId, publicWebsite, moreInfo, type, schedule, problemCategories, isActive, generateDailyReport, needInformByEmail, needInformBySms);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContractorForm {\n");
